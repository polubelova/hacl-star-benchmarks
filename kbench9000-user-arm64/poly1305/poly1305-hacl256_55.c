...
void
Hacl_Impl_Poly1305_Field32xN_256_load_acc4_55(Lib_IntVector_Intrinsics_vec256 *acc, uint8_t *b)
{
...
void
Hacl_Impl_Poly1305_Field32xN_256_fmul_r4_normalize_55(
...
void Hacl_Poly1305_256_poly1305_init_55(Lib_IntVector_Intrinsics_vec256 *ctx, uint8_t *key)
{
...
void
Hacl_Poly1305_256_poly1305_update_55(
...
)
{
  ...
  if (len0 > (uint32_t)0U)
  {
    ...
    uint8_t *text0 = t0;
    Hacl_Impl_Poly1305_Field32xN_256_load_acc4_55(acc, text0);
    ...
    for (uint32_t i = (uint32_t)0U; i < nb; i++)
    {
      ...
      */
      ...
      Lib_IntVector_Intrinsics_vec256
      m2 = Lib_IntVector_Intrinsics_vec256_shift_right(m0, (uint32_t)48U);
      m0 = Lib_IntVector_Intrinsics_vec256_interleave_low64(m0, m1); // m0 
      Lib_IntVector_Intrinsics_vec256
      m3 = Lib_IntVector_Intrinsics_vec256_shift_right(m1, (uint32_t)48U);
      m2 = Lib_IntVector_Intrinsics_vec256_interleave_low64(m2, m3);
      ...
      Lib_IntVector_Intrinsics_vec256
      mask2610 = Lib_IntVector_Intrinsics_vec256_load64((uint64_t)0x3ffffffU);
      m3 = Lib_IntVector_Intrinsics_vec256_shift_right64(m2, (uint32_t)30U); //m3
      m2 = Lib_IntVector_Intrinsics_vec256_shift_right64(m2, (uint32_t)4U); //m2
      m1 = Lib_IntVector_Intrinsics_vec256_shift_right64(m0, (uint32_t)26U);//m1
      m4 = Lib_IntVector_Intrinsics_vec256_shift_right64(m4, (uint32_t)40U); //m4

      m2 = Lib_IntVector_Intrinsics_vec256_and(m2, mask2610);
      m0 = Lib_IntVector_Intrinsics_vec256_and(m0, mask2610);
      m1 = Lib_IntVector_Intrinsics_vec256_and(m1, mask2610);
      m3 = Lib_IntVector_Intrinsics_vec256_and(m3, mask2610);
      e[0U] = m0;
      e[1U] = m1;
      e[2U] = m2;
      e[3U] = m3;
    ...
    Hacl_Impl_Poly1305_Field32xN_256_fmul_r4_normalize_55(acc, pre);
  }
...
void
Hacl_Poly1305_256_poly1305_finish_55(
  uint8_t *tag,
  uint8_t *key,
  Lib_IntVector_Intrinsics_vec256 *ctx
)
...
void poly1305_hacl256_55(uint8_t *tag, uint8_t *text, uint32_t len1, uint8_t *key)
{
  Lib_IntVector_Intrinsics_vec256 ctx[25U] = {{ 0 }};
  Hacl_Poly1305_256_poly1305_init_55(ctx, key);
  Hacl_Poly1305_256_poly1305_update_55(ctx, len1, text);
  Hacl_Poly1305_256_poly1305_finish_55(tag, key, ctx);
}

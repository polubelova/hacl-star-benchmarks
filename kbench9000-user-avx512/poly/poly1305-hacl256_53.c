...
void
Hacl_Impl_Poly1305_Field32xN_256_fmul_r4_normalize_53(
...
void Hacl_Poly1305_256_poly1305_init_53(Lib_IntVector_Intrinsics_vec256 *ctx, uint8_t *key)
{
...
void
Hacl_Poly1305_256_poly1305_update_53(
...
)
{
  ...
  if (len0 > (uint32_t)0U)
  {
    ...
    uint8_t *text0 = t0;
    Hacl_Impl_Poly1305_Field32xN_256_load_acc4_53(acc, text0);
    ...
    Hacl_Impl_Poly1305_Field32xN_256_fmul_r4_normalize_53(acc, pre);
  }
...
void
Hacl_Poly1305_256_poly1305_finish_53(
  uint8_t *tag,
  uint8_t *key,
  Lib_IntVector_Intrinsics_vec256 *ctx
)
...
void poly1305_hacl256_53(uint8_t *tag, uint8_t *text, uint32_t len1, uint8_t *key)
{
  Lib_IntVector_Intrinsics_vec256 ctx[25U] = {{ 0 }};
  Hacl_Poly1305_256_poly1305_init_53(ctx, key);
  Hacl_Poly1305_256_poly1305_update_53(ctx, len1, text);
  Hacl_Poly1305_256_poly1305_finish_53(tag, key, ctx);
}
